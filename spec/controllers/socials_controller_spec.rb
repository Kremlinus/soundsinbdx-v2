...
RSpec.describe SocialsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      social = Social.create! valid_attributes
      get :show, params: {id: social.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      social = Social.create! valid_attributes
      get :edit, params: {id: social.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {social: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested social" do
        social = Social.create! valid_attributes
        put :update, params: {id: social.to_param, social: new_attributes}, session: valid_session
        social.reload
      ...
      it "redirects to the social" do
        social = Social.create! valid_attributes
        put :update, params: {id: social.to_param, social: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        social = Social.create! valid_attributes
        put :update, params: {id: social.to_param, social: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested social" do
      social = Social.create! valid_attributes
      expect {
        delete :destroy, params: {id: social.to_param}, session: valid_session
      }.to change(Social, :count).by(-1)
    end
